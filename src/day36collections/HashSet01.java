...
public class HashSet01 {
	...
	public static void main(String[] args) {
		...
		// 		  2)Key-Value yapisini kullanir. Key'ler ve Valuelar HashSet icin uniqe'dir.
		...
		//List'lerde add() methodu hep yeni elemani sona ekler ama HasHsetler de oyle bir zorunluluk yok 
