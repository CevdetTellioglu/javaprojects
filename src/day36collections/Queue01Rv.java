...
public class Queue01Rv {

	public static void main(String[] args) {
		// Queue :
		/*
		 *      Queue'ya eklenen elemanlar en sona eklenir, list'lerde oldugu gibi
		...
		//PriorityQueue elemanlari natural order'a gore siralar.
		 ...
		 // silmesini gerketigini soyledik, Java true return ederek islem tamam mesaji verir.
