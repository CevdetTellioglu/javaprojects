...
public class StringMethod04 {
	...
	public static void main(String[] args) {
		...
		// Eger o character String icinde varsa true yoksa false return eder.
        ...
        System.out.println(str1.contains("m")); // False gormemiz lazim cunku karakartal in icinde m yok 
