...
public class ArrayListRv03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(list01.remove(0));// ilk elamani sildim
											// Sildigim ilk degeri bana verir 

		// "Ayse" elemanini "Aysegul" yapalim. set() methodu kullanilir.
